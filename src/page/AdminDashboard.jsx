...
export const AdminDashboard = ({ token, userName }) => {
  ...
  // ✅ FORZAR valores de admin al cargar (solo una vez)
  useEffect(() => {
    ...
    const fetchAdminData = async () => {
      try {
        ...
        if (res.ok) {
          ...
          const completados = archivos.filter(
      ...
      <main className="container mx-auto px-4 sm:px-6 pb-8 sm:pb-12">
          ...
          {statCards.map((stat, idx) => (
            <div key={idx} className="bg-white rounded-xl shadow-sm p-3 sm:p-5">
              <div className="flex justify-between items-start mb-2 sm:mb-3">
                ...
                <div
                  className={`${colorClasses[stat.color].bg} p-1.5 sm:p-2.5 rounded-lg flex-shrink-0 ml-2`}
                >
                  <svg
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-orange-50 rounded-lg border border-orange-100">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] sm:text-xs text-gray-600 mt-0.5">
                      Todas las solicitudes están sincronizadas
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 hover:bg-gray-50 rounded-lg transition-colors cursor-pointer">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] sm:text-xs text-gray-600 mt-0.5">
                      {stats.proyectosActivos} solicitudes esperando aprobación
                    </p>
                  </div>
                  <span className="text-[10px] sm:text-xs text-gray-500 whitespace-nowrap flex-shrink-0">
                    Hoy
                ...
                <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 hover:bg-gray-50 rounded-lg transition-colors cursor-pointer">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] sm:text-xs text-gray-600 mt-0.5">
                      {stats.rendimiento}% de solicitudes completadas
                    </p>
                  </div>
                  <span className="text-[10px] sm:text-xs text-gray-500 whitespace-nowrap flex-shrink-0">
                    Esta semana
                ...
                <div className="pt-2 sm:pt-3 border-t border-gray-100">
                  ...
                  <div className="space-y-1">
                    <Link
                      ...
                      className="flex items-center gap-2 text-xs sm:text-sm text-gray-700 hover:text-orange-600 py-1 sm:py-1.5"
                    >
                      <svg
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-5 gap-2 sm:gap-3">
            <div>
              <h2 className="text-base sm:text-lg font-bold text-gray-900 mb-0.5 sm:mb-1">
                Solicitudes Activas
              </h2>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                <div
                  className={`p-2 sm:p-3 rounded-xl flex-shrink-0 ${
                    action.primary ? "bg-orange-50" : "bg-blue-50"
                  }`}
                >
                  <svg
                    className={`w-5 h-5 sm:w-7 sm:h-7 ${
                      action.primary ? "text-orange-500" : "text-blue-500"
                    }`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span
                    className={`text-xs sm:text-sm font-semibold inline-flex items-center ${
                      action.primary ? "text-orange-500" : "text-blue-500"
                    }`}
                  >
