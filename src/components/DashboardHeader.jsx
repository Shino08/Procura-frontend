        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-3">
              ...
              {actions && <div className="hidden lg:flex items-center space-x-2">{actions}</div>}
              ...
              {/* Settings Button - Removido, ahora admin también usa notificaciones */}
          ...
          {mobileOpen && (
            <div className="md:hidden mt-4 pt-4 border-t border-gray-200 animate-fadeIn">
              ...
              <div className="space-y-2">
                ...
                {/* Configuración removida - admin usa notificaciones */}
